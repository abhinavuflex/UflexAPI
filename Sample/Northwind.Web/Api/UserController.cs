...
{
    public class tblUserController : ODataController
    {
        private readonly IUserService _customerService;
        private readonly IUnitOfWorkAsync _unitOfWorkAsync;

        public tblUserController()  { }
        public tblUserController(
        ...
        [HttpGet]
        [ActionName("GetCustomer3")]
        public IQueryable<tblUser> GetCustomer3()
        {
        ...
        [HttpGet]
        ////
        public void InitiateDetails(InitiateDetails objInitiateDetails)
        {
           
          //  _customerService.InsertInitiateDetails(objInitiateDetails); 
        }
        // GET: odata/Customers
        [HttpGet]
       
        public IQueryable<tblUser> GetCustomer()
        {
            return _customerService.Queryable();
        }
